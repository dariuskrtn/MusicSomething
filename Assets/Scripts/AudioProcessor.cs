...
public class AudioProcessor : MonoBehaviour
{
	...
	public float BPM()
	{
		return (float)System.Math.Round (60 / (tempopd2 * framePeriod));
	}
	...
	public Autoco getAutoco(int length)
	{
		return new Autoco (length, alph, framePeriod, getBandWidth());
	}
